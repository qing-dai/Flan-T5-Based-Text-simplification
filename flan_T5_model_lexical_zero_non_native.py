...
prompt_template = (
    "Please rewrite the following complex sentence to make it easier to understand by non-native speakers of English."
...
with open("output_data_flan_t5_base_lexical_zero_non_native.json", "w") as outfile:
