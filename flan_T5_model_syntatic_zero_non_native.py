...
prompt_template = (
    ...
    "Focus on simplifying the syntax by breaking long sentences into shorter ones, ensuring each sentence conveys a "
    "single, clear idea."
    "Use simple, direct sentence structures and replace passive voice with active voice. Avoid nested clauses and "
    "complex grammatical constructions."
    "The final sentence should be grammatical, fluent, and retain the main ideas without changing the meaning.\n\n"
...
with open("output_data_flan_t5_base_syntactic_zero_non_native.json", "w") as outfile:
