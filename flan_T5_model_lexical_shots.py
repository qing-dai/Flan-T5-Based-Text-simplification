...
prompt_template = (
    "Please rewrite the following complex sentence to make it easier to understand for people who need assistive "
    "technology for reading, such as individuals with dyslexia or autism."
    "Focus on simplifying the vocabulary by using more common and familiar words. Make sure to convey the same "
    "meaning while ensuring the sentence is clear and easy to read."
    "Avoid jargon, technical terms, and complex structures. The final simplified sentence should be grammatical, "
    "fluent, and retain the main ideas of the original sentence without altering its meaning.\n\n"
    f"{few_shot_examples}"
...
with open("output_data_flan_t5_base_lexical_shots.json", "w") as outfile:
